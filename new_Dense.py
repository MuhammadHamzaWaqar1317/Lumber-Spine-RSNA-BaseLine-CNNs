...
OUTPUT_DIR = r"D:\Machine Learning\Lumber_Spine_RSNA\models_7class"
IMG_SIZE = (224, 224)
NUM_CLASSES = 7
EPOCHS = 50
SEED = 42
...
BATCH_SIZE = 128 * strategy.num_replicas_in_sync  # you can tune this for RTX 3090
...
# CALLBACKS
# -------------------------------
checkpoint_path = os.path.join(OUTPUT_DIR, "best_densenet201_7class.h5")
cbs = [
...
model.save(os.path.join(OUTPUT_DIR, "final_densenet201_7class.h5"))
print("✔ Model saved.")

# -------------------------------
# FAST TEST METRICS
# -------------------------------
print("\n===== Generating Test Report (FAST MODE) =====\n")

# Single batch for all test images
test_images, test_labels = next(iter(test_ds.unbatch().batch(999999)))
y_true = test_labels.numpy()
y_pred_probs = model.predict(test_images, batch_size=256, verbose=0)
